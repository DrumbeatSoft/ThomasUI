...
public class ThomasTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            fillStatusBar = array.getBoolean(R.styleable.ThomasTitleBar_fillStatusBar, true);
        }
        titleBarColor = array.getColor(R.styleable.ThomasTitleBar_titleBarColor, Color.parseColor("#ffffff"));
        titleBarHeight = (int) array.getDimension(R.styleable.ThomasTitleBar_titleBarHeight, dp2PxInt(context, 44));
        statusBarColor = array.getColor(R.styleable.ThomasTitleBar_statusBarColor, Color.parseColor("#ffffff"));
        statusBarMode = array.getInt(R.styleable.ThomasTitleBar_statusBarMode, 0);

        showBottomLine = array.getBoolean(R.styleable.ThomasTitleBar_showBottomLine, true);
        bottomLineColor = array.getColor(R.styleable.ThomasTitleBar_bottomLineColor, Color.parseColor("#dddddd"));
        bottomShadowHeight = array.getDimension(R.styleable.ThomasTitleBar_bottomShadowHeight, dp2PxInt(context, 0));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextColor = array.getColor(R.styleable.ThomasTitleBar_leftTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            leftTextSize = array.getDimension(R.styleable.ThomasTitleBar_leftTextSize, dp2PxInt(context, 16));
            ...
            leftImageResource = array.getResourceId(R.styleable.ThomasTitleBar_leftImageResource, R.drawable.thomas_titlebar_reback_selector);
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.ThomasTitleBar_rightTextColor, getResources().getColor(R.color.comm_titlebar_text_selector));
            rightTextSize = array.getDimension(R.styleable.ThomasTitleBar_rightTextSize, dp2PxInt(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextColor = array.getColor(R.styleable.ThomasTitleBar_centerTextColor, Color.parseColor("#333333"));
            centerTextSize = array.getDimension(R.styleable.ThomasTitleBar_centerTextSize, dp2PxInt(context, 18));
            ...
            centerSubTextColor = array.getColor(R.styleable.ThomasTitleBar_centerSubTextColor, Color.parseColor("#666666"));
            centerSubTextSize = array.getDimension(R.styleable.ThomasTitleBar_centerSubTextSize, dp2PxInt(context, 11));
            ...
            centerSearchBgResource = array.getResourceId(R.styleable.ThomasTitleBar_centerSearchBg, R.drawable.thomas_titlebar_search_gray_shape);
            centerSearchRightType = array.getInt(R.styleable.ThomasTitleBar_centerSearchRightType, TYPE_CENTER_SEARCH_RIGHT_VOICE);
    ...
    private void initGlobalViews(Context context) {
        ...
        boolean transparentStatusBar = supportTransparentStatusBar();

        // 构建标题栏填充视图
        if (fillStatusBar && transparentStatusBar) {
            int statusBarHeight = getStatusBarHeight(context);
            viewStatusBarFill = new View(context);
            viewStatusBarFill.setId(generateThomasViewId());
        ...
        rlMain.setId(generateThomasViewId());
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, dp2PxInt(context, 0.4f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, dp2PxInt(context, 0.4f)));
            ...
            viewBottomShadow.setBackgroundResource(R.drawable.thomas_titlebar_bottom_shadow);
            LayoutParams bottomShadowParams = new LayoutParams(MATCH_PARENT, dp2PxInt(context, bottomShadowHeight));
    ...
    private void initMainLeftViews(Context context) {
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            tvLeft.setId(generateThomasViewId());
            ...
            btnLeft.setId(generateThomasViewId());
            ...
            if (viewCustomLeft.getId() == View.NO_ID) {
                viewCustomLeft.setId(generateThomasViewId());
            }
    ...
    private void initMainRightViews(Context context) {
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            tvRight.setId(generateThomasViewId());
            ...
            btnRight.setId(generateThomasViewId());
            ...
            if (viewCustomRight.getId() == View.NO_ID) {
                viewCustomRight.setId(generateThomasViewId());
            }
    ...
    private void initMainCenterViews(Context context) {
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            llMainCenter.setId(generateThomasViewId());
            ...
            progressCenter.setIndeterminateDrawable(getResources().getDrawable(R.drawable.thomas_titlebar_progress_draw));
            progressCenter.setVisibility(View.GONE);
            int progressWidth = dp2PxInt(context, 18);
            ...
            ivSearch.setId(generateThomasViewId());
            ...
            ivVoice.setId(generateThomasViewId());
            ...
            etSearchHint.setHint(getResources().getString(R.string.thomasTitleBarSearchHint));
            ...
            if (centerCustomView.getId() == View.NO_ID) {
                centerCustomView.setId(generateThomasViewId());
            }
...
//            }
    ...
    public void setLeftView(View leftView) {
        if (leftView.getId() == View.NO_ID) {
            leftView.setId(generateThomasViewId());
        }
        LayoutParams leftInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        leftInnerParams.addRule(RelativeLayout.ALIGN_PARENT_START);
        leftInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
    ...
    public void setCenterView(View centerView) {
        if (centerView.getId() == View.NO_ID) {
            centerView.setId(generateThomasViewId());
        }
    ...
    public void setRightView(View rightView) {
        if (rightView.getId() == View.NO_ID) {
            rightView.setId(generateThomasViewId());
        }
        LayoutParams rightInnerParams = new LayoutParams(WRAP_CONTENT, MATCH_PARENT);
        rightInnerParams.addRule(RelativeLayout.ALIGN_PARENT_END);
        rightInnerParams.addRule(RelativeLayout.CENTER_VERTICAL);
    ...
    public void showSoftInputKeyboard(boolean show) {
        if (centerSearchEditable && show) {
            ...
            showSoftInputKeyBoard(getContext(), etSearchHint);
        } else {
            hideSoftInputKeyBoard(getContext(), etSearchHint);
        }
    }
    ...
    private static int dp2PxInt(Context context, float dp) {
        return (int) (dp2Px(context, dp) + 0.5f);
    }

    private static float px2DpCeilInt(Context context, float px) {
     ...
     * @return
     */
    private static int[] getScreenPixelSize(Context context) {
        DisplayMetrics metrics = getDisplayMetrics(context);
        return new int[]{metrics.widthPixels, metrics.heightPixels};
    }

    private static void hideSoftInputKeyBoard(Context context, View focusView) {
        if (focusView != null) {
    ...
    private static void showSoftInputKeyBoard(Context context, View focusView) {
    ...
    private static int getAppInScreenheight(Context context) {
        return getScreenHeight(context) - getStatusBarHeight(context);
    }


    private static boolean supportTransparentStatusBar() {
        return isMiui()
                || isFlyme()
    ...
    private static void setFlymeStatusBarDarkMode(Window window, boolean darkMode) {
        setStatusBarDarkIcon(window, darkMode);
    }
     ...
     * @param alpha
     */
    private static void setStatusBarColor(Window window, @ColorInt int color, int alpha) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
     ...
     * @return
     */
    private static int generateThomasViewId() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
